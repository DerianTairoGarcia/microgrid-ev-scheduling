...
data = {'set_of_time': T, 
        ...
        'resistance_raa': [0.4138, 0.4138, 0.4138, 0.4138], 
        'resistance_rbb': [0.4138, 0.4138, 0.4138, 0.4138], 
        'resistance_rcc': [0.4138, 0.4138, 0.4138, 0.4138], 
        'resistance_rab': [0.0523, 0.0523, 0.0523, 0.0523], 
        'resistance_rac': [0.0523, 0.0523, 0.0523, 0.0523], 
        'resistance_rbc': [0.0523, 0.0523, 0.0523, 0.0523], 
        'reactance_xaa':  [0.8258, 0.8258, 0.8258, 0.8258], 
        'reactance_xbb':  [0.8258, 0.8258, 0.8258, 0.8258], 
        'reactance_xcc':  [0.8258, 0.8258, 0.8258, 0.8258], 
        'reactance_xab':  [0.4765, 0.4765, 0.4765, 0.4765], 
        'reactance_xac':  [0.4765, 0.4765, 0.4765, 0.4765], 
        'reactance_xbc':  [0.4765, 0.4765, 0.4765, 0.4765], 
        'nominal_voltage': 11.9, 
        'maximum_current_of_lines': [999.0, 999.0, 999.0, 999.0], 
        'maximum_power_PCC': [1000.0, 0, 0, 0, 0], 
        'variation_of_time': 60, 
        'energy_cost': [0.116, 0.116, 0.116, 0.116, 0.116, 0.116, 0.116, 0.116, 0.116, 0.116, 0.116, 0.116, 0.116, 0.116, 0.116, 0.167, 0.167, 0.254, 0.254, 0.254, 0.167, 0.167, 0.116, 0.116], 
        'load_curtailment_cost': [500.0, 500.0, 500.0, 500.0, 0], 
        'nominal_active_load_phase_a': [1, 1, 123.66666666666667, 1, 1], 
        'nominal_active_load_phase_b': [1, 1, 123.66666666666667, 1, 1], 
        'nominal_active_load_phase_c': [1, 1, 123.66666666666667, 1, 1], 
        'nominal_reactive_load_phase_a': [1, 1, 1.0, 1, 1], 
        'nominal_reactive_load_phase_b': [1, 1, 1.0, 1, 1], 
        'nominal_reactive_load_phase_c': [1, 1, 1.0, 1, 1],
        ...
        'photovoltaic_generation_phase_a': [0, 0, 0, 0, 245.33333333333334], 
        'photovoltaic_generation_phase_b': [0, 0, 0, 0, 245.33333333333334], 
        'photovoltaic_generation_phase_c': [0, 0, 0, 0, 245.33333333333334],
...
cEDS = {}
for index in range(len(data["energy_cost"])):
	cEDS[T[index]] = data["energy_cost"][index]

alpha_c = {}
for index in range(len(data['load_curtailment_cost'])):
	alpha_c[N[index]] = data['load_curtailment_cost'][index]
